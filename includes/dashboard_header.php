    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            <div style="height: 64px; display: flex; align-items: center; padding: 0 16px; border-bottom: 1px solid var(--border-color); overflow: hidden;">
                ...
                <div class="sidebar-text" style="margin-left: 12px; overflow: hidden;">
                    <div style="font-weight: 800; color: var(--text-main); font-size: 16px; letter-spacing: -0.02em; white-space: nowrap;">Momentask</div>
                    <div style="font-size: 10px; color: var(--text-muted); white-space: nowrap; margin-top: 1px;">Small steps. Big progress.</div>
                </div>
            </div>
            ...
            <div style="padding: 12px; border-top: 1px solid var(--border-color);">
                <div style="display: flex; align-items: center; gap: 12px; padding: 10px 12px; border-radius: 12px; background: rgba(0,0,0,0.03);">
                    <div class="avatar"><?= htmlspecialchars($user['avatar']) ?></div>
                    <div class="sidebar-text" style="overflow: hidden; flex: 1;">
                        <div style="font-size: 13px; font-weight: 700; color: var(--text-main); white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?= htmlspecialchars($user['name']) ?></div>
                        <div style="font-size: 11px; color: var(--text-muted); white-space: nowrap;">Pro Plan ✨</div>
                    </div>
                </div>
            </div>
        </aside>
        ...
        <main class="main-content">
            ...
            <header class="top-header">
                <button id="toggle-sidebar" class="d-none d-md-flex align-items-center justify-content-center" style="padding: 8px; border-radius: 10px; border: none; background: transparent; cursor: pointer; color: var(--text-muted);">
                    <i data-lucide="chevron-left" width="18"></i>
                </button>
                <button id="mobile-menu-btn" class="d-md-none align-items-center justify-content-center" style="padding: 8px; border-radius: 10px; border: none; background: transparent; cursor: pointer; color: var(--text-muted);">
                    <i data-lucide="menu" width="18"></i>
                </button>
                
                <div style="display: flex; align-items: center; gap: 8px; padding: 8px 14px; border-radius: 12px; background: #F3F4F6; flex: 1; max-width: 320px;" class="hide-mobile">
                ...
                <button id="theme-toggle" style="padding: 8px; border-radius: 10px; border: none; background: transparent; cursor: pointer; color: var(--text-muted); display: flex;">
                    <i data-lucide="moon" width="18"></i>
                </button>
                
                <a href="logout.php" style="padding: 8px; border-radius: 10px; border: none; background: transparent; cursor: pointer; color: var(--danger); display: flex;" title="Logout">
